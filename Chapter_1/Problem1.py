print('''
I am a tech-focused learner with a strong interest in programming and real-world problem solving. I work with languages like Python and Java, and I enjoy building practical projects that can be applied in real scenarios.
